...
public class InstagramActivity extends FragmentActivity {
    ...
    private void setUpBottomNavBar() {
        ...
        //NavigationUI.setupWithNavController(bottomNavigationView, navController); //back to home page
        AlternativeNavigationUI.setupWithNavController(bottomNavigationView, navController); //back to last page
